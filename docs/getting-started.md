...
- Keep `src/`, `tests/`, and `tools/` clean as real code appears.

## Suggested Study Order

1. Boot process.
2. Kernel entry and task model.
3. Memory management.
4. Filesystem layout.
5. HolyC and the shell.
6. Graphics and input.
7. Build and emulator workflow.
